 ...
 * 
 * Script Name: Basic_Checks_For_Logical_Interfaces
 * Author: Kiran Mukkamala
 * Purpose: To check the L3 logical interface issues 
 * Date: 15.06.2023
 */
...
function OnProjectBrowserScript()
{
	...
	Session.Output("<============ Script Basic_Checks_For_Logical_Interfaces Started ============>");
	...
	switch ( treeSelectedType )
	{
		...
		case otPackage :
		{
			...
			for (var i=0; i< ElementList.Count;i++)
			{
				...
				{
					var previousfinding = Finding;
					ExploreElement(thePackage.Name, ele.Stereotype, ele.Elements, 1);
					if( Finding > previousfinding)
					{
	...
	Session.Output("<============ Script Basic_Checks_For_Logical_Interfaces Ended ============>");
}
